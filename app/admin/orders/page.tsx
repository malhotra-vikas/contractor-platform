...
import { Building2, Package, Search, Eye, Truck, CheckCircle, Clock, AlertCircle, DollarSign } from "lucide-react"
    ...
    if (searchTerm) {
      filtered = filtered.filter(
        (order) =>
          ...
          order.subcontractor_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
          order.subcontractor_company.toLowerCase().includes(searchTerm.toLowerCase()),
      )
    }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search by order number, company, or contact..."
              value={searchTerm}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          {order.subcontractor_name} • {order.subcontractor_company}
                        </CardDescription>
                      </div>
                    </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm">
                        <span className="font-medium">Quote:</span> {order.quote_number}
                      </p>
                    </div>
                    <div>
